...
// Correct the path to import the models
const Admin = require('./adminModel'); // Assuming your admin model file is named 'adminModel.js'
const Voter = require('./voterModel'); // Assuming your voter model file is named 'voterModel.js'
